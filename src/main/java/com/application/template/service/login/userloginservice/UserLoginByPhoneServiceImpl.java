...
@Service
@Transactional
public class UserLoginByPhoneServiceImpl extends UserLoginServiceImpl implements UserLoginService, InitializingBean {
    ...
    public void afterPropertiesSet(){
        UserLoginServiceFactory.putUserLoginService(LoginAuthWay.PHONE, this);
    }
}
